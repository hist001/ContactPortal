 ...
 * 창 - 환경 설정 - Java - 코드 스타일 - 코드 템플리트
 */
public class ComPopupDTO extends GeneralDTO{

	public String codeNo;     		//시스템 코드
	public String code;   	  		//코드
	public String codeName;   		//코드명
	public String code2;   	  		//코드(프로젝트수행일자)
	public String codeName2;   		//코드명(프로젝트종료일자)
	public String highCode;   		//상위코드
	public String highCodeName;   	//상위코드명
	public String HIGHDOCNO;   		//산출물 상위코드
	public String LEVELSUBCNT;   	//산출물 하위 폴더 수
