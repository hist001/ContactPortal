...
public class ProdDTO extends GeneralDTO implements DTO 
{
	...
	public long contAmt;			//매출금액
	public long supplyAmt;			//공급가액	--> 2005.08.19 추가
	public String contFlag;			//수행형태	--> 2005.08.19 추가
	...
	public String maTerm;				//하자보수기간 -->수정
	...
	public BilColDtDTO[] bilColDtDTOs;	//청구수금
	public InstallDTO[] installDTOs;		//설치내역
	public PrcsDTO[] prcsDTOs;			//공정
	
	public HashMap prodEmps;				//제품인원정보
