...
<body text="#000000" style="background-color=#FFFFFF" topmargin=0 leftmargin=0 rightmargin=0 onload="init('<%=ui_no%>','<%=obj_no%>');">
...
%>
			...
			for(int i=0;i<files.length;i++){
				...
				<script>				
				selectFileView('<%=files[i].file_no%>',
					       '<%=files[i].dir%>',
