...
<FORM   id="com_Files" method="Post" action='/common/imageUpload.jsp?ui_no=<%=ui_no%>&obj_no=<%=obj_no%>&dir=<%=dir%>' enctype="multipart/form-data">
...
%>
			...
			for(int i=0;i<files.length;i++){
				...
				if(files[i].delFlag.equals("N") && (files[i].CHK.equals("JPG") || files[i].CHK.equals("PNG") 
				|| files[i].CHK.equals("BMP") || files[i].CHK.equals("GIF") || files[i].CHK.equals("TIF"))){%>				
				<script>				
