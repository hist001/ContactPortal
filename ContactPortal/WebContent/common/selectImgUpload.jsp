...
//		System.out.println("selectUpload.jsp dir===>>>"+dir);
		try {			
			...
			/*select*/
			String sql="select a.*, upper(substr(substr(a.FILEORIGINNAME,-5,5),instr(substr(a.FILEORIGINNAME,-5,5),'.')+1))CHK from Com_Files a \n"+
...
//			System.out.println("selectUpload sql ==>/n" + sql);
			...
			RequestDispatcher dispatcher = application.getRequestDispatcher("/common/imageUpload.jsp?ui_no="+ui_no+"&obj_no="+obj_no+"&dir="+dir);
